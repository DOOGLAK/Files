...
fin_results["Article"][50][3][47].keys()
#fin_results["Tagged_Uni"][50][1].keys()
...
# nested_dict={}
# nested_dict["Article"]={}
# nested_dict["Article"]["Small"]={}
# nested_dict["Article"]["Small"][0]={}
# nested_dict["Article"]["Small"][0][7] = []

# dict_new = {"Article":{"Size":{"Attempt":{"Indeces":[]}}}}
...
#for idz in list(fin_results[variant][size][repetition].keys()):
#    print(fin_results[variant][size][6])#



#testing = df_og_train[fin_results["Tagged_One"][500][9][125]]

    ...
    for variant in variants:
        for size in sizes:
            for j in repetition:
                ...
                ner_feature = raw_datasets["validation"].features["ner_tags"]
                ner_feature
                ...
                inputs = tokenizer(raw_datasets["validation"][0]["tokens"], is_split_into_words=True)
                inputs.tokens()
                inputs.word_ids()
                ...
                labels = raw_datasets["validation"][0]["ner_tags"]
                ...
                batch = data_collator([tokenized_datasets["validation"][i] for i in range(2)])
                batch["labels"]
                ...
                time_dict[variant+str(size)+"v"+str(i)]=minutes

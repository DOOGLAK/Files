    ...
    for variant in variants:
        for size in sizes:
            for i in repetition: #or list
                ...
                file[47] = '    "H:\\\\My Files\\\\School\\\\Grad School WLU\\\\MRP\\\\Research\\\\Files\\\\Data\\\\Textfiles\\\\'+variant+'\\\\'+str(size)+'\\\\v'+str(i)+'_Testing.txt"'
                file[51] = '    "H:\\\\My Files\\\\School\\\\Grad School WLU\\\\MRP\\\\Research\\\\Files\\\\Data\\\\Textfiles\\\\'+variant+'\\\\'+str(size)+'\\\\v'+str(i)+'_UnAugmented.txt"'
